  ...
  useEffect(() => {
    ...
    if (savedTasks) {
      ...
      const defaultTasks: Task[] = [
        {
          id: "default-1",
          title: "Sambut pagi dengan senyuman dan segelas air hangat 🌸",
          description: "Rutinitas sehat untuk memulai hari yang indah.",
          category: "Self-Care",
          priority: "low",
        ...
        {
          id: "default-3",
          title: "Beli buah segar dan sayuran 🥦",
          description: "Apel, alpukat, dan bayam untuk stok jus sehat.",
          category: "Belanja",
          priority: "medium",
